...
set_property PACKAGE_PIN U21 [get_ports {tx_d[0]}]
set_property PACKAGE_PIN W22 [get_ports {tx_d[1]}]
set_property PACKAGE_PIN W21 [get_ports {tx_d[2]}]
set_property PACKAGE_PIN Y22 [get_ports {tx_d[3]}]
...
set_property PACKAGE_PIN AA19 [get_ports tx_dv]
set_property PACKAGE_PIN U22 [get_ports tx_clk]
