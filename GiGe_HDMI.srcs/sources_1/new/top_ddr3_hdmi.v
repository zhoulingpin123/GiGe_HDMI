...
ddr3_clk_gen ddr3_clk_gen_inst
   (
    ...
    .clk_out3(tx_sclk),     // output clk_out3
    .clk_out4(tx_c),     // output clk_out4
   // Clock in ports
...
always @(posedge clk1x) begin
  ...
  else if (phy_rst_cnt[19] == 1'b0) begin
    phy_rst_cnt <= phy_rst_cnt + 1'b1;
  end
end
assign phy_rst_n = phy_rst_cnt[19] ;
...
ddr3_ctrl u_ddr3_ctrl (
  ...
  chechsum_ctrl inst_chechsum_ctrl (
      .tx_clk      (tx_sclk),
      .rst         (rst),
      .tx_gen_data (tx_data),
      .tx_data_en  (tx_en),
