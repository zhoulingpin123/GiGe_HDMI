...
#
# Generated by Vivado on Wed Aug 21 23:09:45 +0800 2024
...
# Script info
echo -e "afifo_wr16x64.sh - Script generated by export_simulation (Vivado v2019.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L fifo_generator_v13_2_5 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot afifo_wr16x64 xil_defaultlib.afifo_wr16x64 xil_defaultlib.glbl -log elaborate.log
}
