...
#
# Generated by Vivado on Sat Aug 17 16:32:01 +0800 2024
...
# Script info
echo -e "afifo_wr8x8192.sh - Script generated by export_simulation (Vivado v2019.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L fifo_generator_v13_2_5 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot afifo_wr8x8192 xil_defaultlib.afifo_wr8x8192 xil_defaultlib.glbl -log elaborate.log
}
