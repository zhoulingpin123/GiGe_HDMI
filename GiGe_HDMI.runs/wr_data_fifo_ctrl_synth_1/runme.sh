...
HD_PWD='E:/fpga_image/vivadoproject_2019.2/GiGe_HDMI/GiGe_HDMI.runs/wr_data_fifo_ctrl_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log wr_data_fifo_ctrl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source wr_data_fifo_ctrl.tcl
