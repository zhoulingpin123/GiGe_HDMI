...
HD_PWD='E:/fpga_image/vivadoproject_2019.2/GiGe_HDMI/GiGe_HDMI.runs/fifo_wr16x1024_rd128x128_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_wr16x1024_rd128x128.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo_wr16x1024_rd128x128.tcl
