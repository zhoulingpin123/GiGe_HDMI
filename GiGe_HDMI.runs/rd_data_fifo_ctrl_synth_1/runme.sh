...
HD_PWD='E:/fpga_image/vivadoproject_2019.2/GiGe_HDMI/GiGe_HDMI.runs/rd_data_fifo_ctrl_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rd_data_fifo_ctrl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rd_data_fifo_ctrl.tcl
