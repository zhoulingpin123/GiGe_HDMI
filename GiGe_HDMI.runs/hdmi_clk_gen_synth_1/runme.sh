...
HD_PWD='E:/fpga_image/vivadoproject_2019.2/GiGe_HDMI/GiGe_HDMI.runs/hdmi_clk_gen_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_clk_gen.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hdmi_clk_gen.tcl
